...
# === Estrazione base con logica migliorata ===
...
def extract_all_values_smart(text):
    keywords_map = {
        ...
        "Totale Attivo": ["Totale attivo", "Attività totali", "Total Assets", "Total assets"],
        "Patrimonio Netto": ["Capitale proprio", "Patrimonio netto", "Net Equity", "PN", "Total equity", "Equity"]
    }
    risultati = {}
