...
st.set_page_config(page_title="Audit Flow Hybrid - Complete Fixed", layout="wide")
st.title("Audit Flow Pro+ Hybrid")
st.subheader("PDF, Excel, CSV + KPI, grafici, GPT facoltativo")
...
if uploaded_file:
    ...
    # Cast tutti i valori a numerico se possibile
    for key in data:
        try:
