...
def extract_structured_data_with_gpt(text, lang, api_key):
    ...
    if lang == "it":
        prompt = (
            "Analizza il seguente testo di bilancio e restituisci solo i valori principali in formato JSON:
"
...
"
        ...
        prompt = (
            "Analyze the following financial report text and return only the key financial values in JSON format:
"
            "- Total Revenue
"
            "- Net Income
